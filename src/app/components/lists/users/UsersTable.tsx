...
export function UsersTable({
  ...
  return (
    <DataTableCard
      ...
      action={loading ? <span className="text-xs font-medium text-slate-400">Loading users...</span> : null}
      columns={[
        {
          key: "id",
          header: "User ID",
          sortable: true,
          renderCell: (user) => <CopyableIdChip value={user.id} label="Copy User ID" />,
        },
        {
          key: "name",
          header: "Name",
          ...
          renderCell: (user) => (
            <div>
              ...
              <p className="mt-1 text-[10px] text-slate-400">{user.phone || user.office || "—"}</p>
            </div>
          ),
        },
        {
            ...
            <div className="space-y-1">
              ...
              {user.employeeId ? (
                <CopyableIdChip
                  ...
                  className="bg-transparent px-0 text-slate-500 dark:text-slate-300"
                />
              ) : null}
            </div>
          ),
