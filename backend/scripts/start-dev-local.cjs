...
Object.assign(process.env, {
  ...
  JWT_ISSUER: process.env.JWT_ISSUER || 'projtrack-api-local',
  JWT_AUDIENCE: process.env.JWT_AUDIENCE || 'projtrack-web-local',
  ...
  ALLOW_DEMO_SEED: process.env.ALLOW_DEMO_SEED || 'false',
