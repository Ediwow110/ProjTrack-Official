  ...
  return (
    <label className="space-y-2">
      ...
      <input
        ...
        disabled={disabled}
        onChange={(event) => onChange(event.target.value)}
        className="h-11 w-full rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900/85 px-3 text-sm text-slate-700 dark:text-slate-200 outline-none focus:border-blue-500 disabled:cursor-not-allowed disabled:bg-slate-100 dark:border-slate-700 dark:bg-slate-900/70 dark:text-slate-100 dark:disabled:bg-slate-800"
      />
    </label>
  );
}
  ...
  return (
    <label className={`space-y-2 ${className ?? ""}`}>
      ...
      <textarea
        ...
        onChange={(event) => onChange(event.target.value)}
        className="min-h-[120px] w-full rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900/85 px-3 py-3 text-sm text-slate-700 dark:text-slate-200 outline-none focus:border-blue-500 dark:border-slate-700 dark:bg-slate-900/70 dark:text-slate-100"
      />
    </label>
  );
}
