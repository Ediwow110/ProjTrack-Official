        ...
        <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
          {filtered.map((subject, index) => (
            <div
              ...
              className="group relative overflow-hidden rounded-[30px] border border-white/70 bg-white/88 dark:bg-slate-900/85 p-6 shadow-[0_24px_70px_-44px_rgba(15,23,42,0.42)] transition duration-200 hover:-translate-y-1 hover:border-brand-primary/30 hover:shadow-[0_30px_75px_-40px_rgba(77,212,172,0.3)]"
            >
              <div className="absolute inset-x-0 top-0 h-24 bg-[radial-gradient(circle_at_top_left,rgba(77,212,172,0.15),transparent_65%)]" />
              <div className="relative">
                <div className="flex items-start justify-between gap-4">
                  <div className="flex gap-4">
                    <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-[22px] bg-brand-primary/15 text-brand-secondary dark:text-brand-primary shadow-inner shadow-white">
                      <BookOpen size={22} strokeWidth={1.8} />
                    </div>
                    <div className="min-w-0">
                      <div className="flex flex-wrap items-center gap-2">
                        <span className="rounded-full bg-brand-primary/15 px-2.5 py-1 text-[11px] font-bold uppercase tracking-[0.18em] text-brand-secondary dark:text-brand-primary">
                          {subject.code}
                        </span>
                  ...
                  <div className="mt-1 rounded-2xl bg-slate-100 dark:bg-slate-800/80 p-2 text-slate-400 dark:text-slate-300 transition group-hover:bg-brand-primary/15 group-hover:text-brand-secondary">
                ...
                <div className="mt-5 flex items-center justify-between rounded-[22px] border border-brand-primary/20 dark:border-brand-primary/15 bg-brand-primary/10 px-4 py-4">
                  <div>
                    <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-brand-secondary dark:text-brand-primary">
                      Activity load
                    </p>
                  ...
                  <div className="text-right">
                    <p className="text-sm font-semibold text-brand-secondary dark:text-brand-primary">Open workspace</p>
