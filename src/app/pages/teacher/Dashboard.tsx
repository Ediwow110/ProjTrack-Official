            ...
            <div className="space-y-3">
              {(data?.upcomingDeadlines ?? []).map((deadline) => (
                <button
                  ...
                  className="w-full rounded-[22px] border border-slate-200 bg-slate-50/85 p-4 text-left transition hover:-translate-y-0.5 hover:border-teal-200 hover:bg-teal-50/70 hover:shadow-[0_18px_45px_-34px_rgba(13,148,136,0.35)]"
                >
                  ...
                  <div className="mt-3 flex items-center justify-between text-xs">
                    <span
                      className={`font-semibold ${
                        deadline.daysLeft <= 1 ? "text-rose-600" : "text-amber-700"
                      }`}
                    >
              ...
              <tbody className="divide-y divide-slate-100">
                {visiblePendingRows.map((row) => (
                  <tr
                    ...
                    className="cursor-pointer bg-white/70 transition hover:bg-teal-50/45"
