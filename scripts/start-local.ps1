...
Write-Host "[start-local] Demo credentials:"
Write-Host "  Admin: admin@projtrack.local / Admin123!ChangeMe"
Write-Host "  Teacher: teacher@projtrack.local / Teacher123!ChangeMe"
Write-Host "  Student: student@projtrack.local or STU-2024-00142 / Student123!ChangeMe"
