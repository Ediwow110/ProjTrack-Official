...
export class MailService {
  ...
  private failureHint(lastError: unknown, failureReason: unknown) {
    ...
    if (
      ...
      return 'Sender not confirmed in Mailrelay. Confirm support@projtrack.codes / notification@projtrack.codes in Mailrelay, or temporarily use admin@projtrack.codes for all MAIL_FROM_* values.';
    }
