            ...
            <div className="space-y-3">
              {(data?.upcomingDeadlines ?? []).map((deadline) => (
                <button
                  ...
                  className="w-full rounded-[22px] border border-slate-200 dark:border-slate-700 bg-slate-50/85 dark:bg-slate-800/70 p-4 text-left transition hover:-translate-y-0.5 hover:border-brand-secondary/30 hover:bg-brand-neutral/20"
                >
      ...
      >
        {pendingRows.length ? (
          <div className="space-y-4">
            <div className="overflow-x-auto" tabIndex={0} aria-label="Pending review queue table">
              ...
              <tbody className="divide-y divide-slate-100 dark:divide-slate-700/60">
                {visiblePendingRows.map((row) => (
                  <tr
                    ...
                    className="cursor-pointer bg-white/70 dark:bg-slate-900/70 transition hover:bg-brand-neutral/20"
